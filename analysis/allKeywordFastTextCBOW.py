...
def getKeywordEmbedding(keywords,model, numWords):
    ...
    out_file = open('/Models/FastTextCBOW/failed_words.txt', 'a+')
...
def getTopicRank(model, articles, query):
    out_file = open('/Models/FastTextCBOW/TopicRankResults/{}.txt'.format(query), 'w+')
...
def getTFIDF(model, articles, query):
    out_file = open('/Models/FastTextCBOW/TFIDF/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
...
def getKPMiner(model, articles, query):
    out_file = open('/Models/FastTextCBOW/KPMINER/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
...
def getYAKE(model, articles, query):
    out_file = open('/Models/FastTextCBOW/YAKE/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
...
def getTextRank(model, articles, query):
    out_file = open('/Models/FastTextCBOW/TextRank/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
...
def getSingleRank(model, articles, query):
    out_file = open('/Models/FastTextCBOW/SingleRank/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
...
def getTopicalRank(model, articles, query):
    out_file = open('/Models/FastTextCBOW/TopicalRank/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
...
def getPositionRank(model, articles, query):
    out_file = open('/Models/FastTextCBOW/PositionRank/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
...
def getMultipartiteRank(model, articles, query):
    out_file = open('/Models/FastTextCBOW/MultipartitieRank/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
...
# train the model
model.train(
    corpus_file='Models/starGEO.txt', epochs=model.epochs, model = 'cbow',
