...
def getKeywordEmbedding(keywords,model, numWords):
    ...
    out_file = open('/Models/SpacyWebLG/failed_words.txt', 'a+')
...
def getTopicRank(model, articles, query):
    out_file = open('/Models/SpacyWebLG/TopicRankResults/{}.txt'.format(query), 'w+')
...
def getTFIDF(model, articles, query):
    out_file = open('/Models/SpacyWebLG/TFIDF/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
...
def getKPMiner(model, articles, query):
    out_file = open('/Models/SpacyWebLG/KPMINER/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
...
def getYAKE(model, articles, query):
    out_file = open('/Models/SpacyWebLG/YAKE/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
...
def getTextRank(model, articles, query):
    out_file = open('/Models/SpacyWebLG/TextRank/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
...
def getSingleRank(model, articles, query):
    out_file = open('/Models/SpacyWebLG/SingleRank/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
...
def getTopicalRank(model, articles, query):
    out_file = open('/Models/SpacyWebLG/TopicalRank/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
...
def getPositionRank(model, articles, query):
    out_file = open('/Models/SpacyWebLG/PositionRank/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
...
def getMultipartiteRank(model, articles, query):
    out_file = open('/Models/SpacyWebLG/MultipartitieRank/{}.txt'.format(query), 'w+')
    path = '/Models/Queries/q{}/'.format(query)
    filenames = getNamesToQuery(path)
    embeddings = []
    sim_to_name = {}
